<template>
  <div class="relative h-full p-4 sm:p-5 flex flex-col overflow-hidden text-left select-none">
    <div class="absolute -right-16 -top-16 h-36 w-36 rounded-full bg-projects-accent/20 blur-xl"></div>
    <div class="absolute -left-16 -bottom-16 h-36 w-36 rounded-full bg-projects-accent-light/10 blur-xl"></div>
...
const projectStatsData = computed(() => props.item.details || []);
</script>
